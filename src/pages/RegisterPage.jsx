...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        toast.success('Account created successfully! Welcome to DropVault!');
        navigate('/dashboard');
      } else {
        ...
        <div className="auth-branding">
          <div className="auth-branding-content">
            ...
            <p className="auth-branding-text">
              Join thousands of users who trust DropVault for their cloud storage needs.
            </p>

            <div className="auth-stats">
              <div className="auth-stat">
                <span className="auth-stat-value">10GB</span>
                <span className="auth-stat-label">Free Storage</span>
              </div>
              <div className="auth-stat">
            ...
            <div className="auth-testimonial">
              <p>"DropVault has transformed how our team shares files. Secure, fast, and incredibly easy to use."</p>
        ...
        <div className="auth-form-section">
          <div className="auth-form-container">
            <div className="auth-form-header">
              ...
              <p>Start with 10GB of free secure storage</p>
            </div>
